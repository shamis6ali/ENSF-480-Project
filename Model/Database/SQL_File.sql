...
LOCK
TABLES `Landlord` WRITE;
/*!40000 ALTER TABLE `Landlord` DISABLE KEYS */;
INSERT INTO `Landlord`
VALUES (''BlDy02'', ''Bill Dipperly'', ''awesomeman71'', ''dipperlyMAN2''),
       (''MxBy01'', ''Max Bay'', ''MaxBayMaster3131'', ''Supersecretpassword''),
       (''Rt7y48'', ''Wilkson'', ''Wkou45'', ''somepass''),
       (''SeTx03'', ''Shingle Trax'', ''TraxSaintsuper'', ''TRAX!!pss''),
       (''TmAe04'', ''Tom Awesome'', ''TomUsername'', ''TGisnottheway1725''),
       (''TyLJs05'', ''Tray L Jonas'', ''Ljones'', ''kgosnmelsd'');
...
INSERT INTO `Manager`
VALUES (''Jnsh01'', ''John Smith'', ''johnSmith'', ''passWordjohn'');
...
VALUES (''pqro05'', ''BlDy02'', ''Unattached House'', 3, 3, 1, 0, ''SW'', ''Rented'', ''3723 Ganges Road'', 5, 12,
        2021),
       (''pqro08'', ''SeTx03'', ''Apartment'', 1, 1, 0, 1, ''SW'', ''Active'', ''5786 Glenna Tunnel Apt. 279'', 25, 11,
        2020),
       (''prop01'', ''MxBy01'', ''Apartment'', 2, 1.5, 0, 1, ''SE'', ''Active'', ''2381 Milton Corner Suite 396'', 24,
        5, 2020),
       (''prop06'', ''SeTx03'', ''Apartment'', 4, 3, 0, 1, ''SE'', ''Rented'', ''850 Mayer Park Apt. 340'', 27, 5,
        2019),
       (''prop07'', ''SeTx03'', ''Bungalow'', 3, 3, 1, 0, ''NW'', ''Active'', ''4655 Craven Place '', 19, 4, 2019),
       (''prop10'', ''TyLJs05'', ''Unattached House'', 10, 7.5, 1, 0, ''SW'', ''Active'', ''412 Rich Grove Street'', 15,
        3, 2021),
       (''prop11'', ''TyLJs05'', ''Apartment'', 3, 3.5, 1, 0, ''NE'', ''Active'', ''137 Murphy Streets Apt. 977'', 4, 8,
        2020),
       (''prp02'', ''MxBy01'', ''Attached House'', 4, 2, 1, 0, ''NW'', ''Active'', ''2388 Tchesinkut Lake Rd'', 8, 7,
        2021),
       (''prpoq03'', ''MxBy01'', ''Townhouse'', 2, 2.5, 1, 0, ''SW'', ''Active'', ''765 Heritage Drive'', 6, 9, 2020),
       (''prpoq09'', ''TmAe04'', ''Townhouse'', 2, 2.5, 1, 0, ''SW'', ''Cancelled'', ''1337 Awesome Street'', 9, 9,
        2020),
       (''prq04'', ''BlDy02'', ''Attached House'', 1, 1, 0, 1, ''NE'', ''Active'', ''1239 Bank St'', 7, 5, 2019);
...
LOCK
TABLES `RRenter` WRITE;
/*!40000 ALTER TABLE `RRenter` DISABLE KEYS */;
INSERT INTO `RRenter`
VALUES (''BgTs02'', ''Big Tings'', ''tingsgoboom'', ''123456789 '', 1),
       (''NiTSs05'', ''Naomi Teehee-Shillings'', ''shoo111'', ''verynicepassword'', 0),
       (''RyJi03'', ''Ray Joani'', ''jaonisoo'', ''big123pass@'', 1),
       (''SzJz04'', ''Suazz Juazz'', ''juazzzzz'', ''paszzzz123'', 0),
       (''TgTi01'', ''Thang Thi'', ''thi1233'', ''bigpassword123'', 0);
...
LOCK
TABLES `Search_Criteria` WRITE;
/*!40000 ALTER TABLE `Search_Criteria` DISABLE KEYS */;
INSERT INTO `Search_Criteria`
VALUES (''s01'', ''Apartment'', 2, 0, 1, 0, ''SW'', ''TgTi01''),
       (''s02'', ''Any'', 0, 3, 1, 1, ''Any'', ''BgTs02''),
       (''s03'', ''Townhouse'', 0, 0, 1, 0, ''SW'', ''RyJi03''),
       (''s04'', ''Any'', 2, 2, 1, 1, ''NE'', ''SzJz04''),
       (''s05'', ''Unattached '', 0, 3, 0, 1, ''NW'', ''NiTSs05'');
