...
public class ReportController {
    ...
    //constructor takes in startM, startD, startY, endM, endD, endY
    //takes in all properties, if date>=startM or <= endM, etc, then add to results list
    //place them in a list and print them all
    //have a list and counter for only rented status props
